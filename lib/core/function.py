...
from utils.vis import save_debug_images, save_batch_heatmaps, save_batch_image_with_joints
...
def test(config, test_loader, test_dataset, model, output_dir, writer_dict=None):
    # switch to evaluate mode
    model.eval()
